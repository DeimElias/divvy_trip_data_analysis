...
iff <- Vectorize(function(name, change, value) {
  if (name == change) {
    value
  } else {
    name
...
df |>
  ...
  select(!station_id:lat) |>
  mutate(start_station_id = iff(start_station_id, "d53ae727-5265-4b8e-a6ca-2a36dc0345c4", "a3a3a282-a135-11e9-9cda-0a87ae2ba916"),
start_station_name =iff(start_station_name, "Wilton Ave & Diversey Pkwy*", "Wilton Ave & Diversey Pkwy"))
```
