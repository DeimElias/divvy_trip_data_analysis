...
We can see that usage from members and casual users doesn't vary much through
seasons. We could confirm this by viewing this graph with a density stat.

We can see more clearly that usage is quite similar on weekends, fact which
points our attention to how different turns out to be the usage of the service
between member and casual users. We can detect 2 spikes of usage at 8am and
5pm, which align perfectly between season. We can suggest that members use the
service in high traffic hours, 
