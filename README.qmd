...
global_theme <-  function() {
  ...
  theme(axis.text.y = element_blank(),
    ...
    strip.background = element_rect(fill = "#53495C", colour = "black"),
    strip.text = element_text(colour = "white"), 
    panel.background = element_rect(fill = "#232323", colour = "black"), 
...
df |>
  ...
  geom_histogram(bins = 31, color = "#9E55FC", fill = "#BB86FC") +
  global_theme() +
